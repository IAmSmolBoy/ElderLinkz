...
import 'package:elderlinkz/test_search.dart';
...
class _TabManagerState extends State<TabManager> with SingleTickerProviderStateMixin {
  int currentIndex = 0;
  List<ScreenData> tabs = const [
    ScreenData(title: "Home", screen: Home(),),
    ScreenData(title: "Patients", screen: PatientsScreen(),),
    ScreenData(title: "Analytics", screen: AnalyticsScreen(),),
    ScreenData(title: "Screen4", screen: Screen4()),
    ScreenData(title: "Settings", screen: SettingsScreen()),
    ScreenData(title: "Search", screen: SearchScreen())
  ];
